    ...
    logs: [
      {
        ...
        description: 'ProfitPath analyzes data from 1000+ suppliers to identify profitable Amazon arbitrage opportunities, featuring automated wholesale scanning, competitor spy search, and comprehensive profit calculations across EU regions & UK.',
        image: {
    ...
    <ScrollArea useScrollAreaId>
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <p>
            I began my journey by creating browser extensions using plain JavaScript, with invaluable support from my team as I initially struggled with HTML and CSS fundamentals. I then progressed to web scraping projects using Python and Node.js. Eventually, I discovered my passion for web development and began mastering Next JS and React JS, along with API design principles.
          </p>
          <p>This technical foundation led me to start developing innovative projects like <Link href="https://profitpath.com/en" className="font-medium underline underline-offset-2 hover:text-accent-500">ProfitPath</Link>, a comprehensive Amazon arbitrage software platform that simplifies online arbitrage for sellers. ProfitPath analyzes data from over 1000+ companies and suppliers, 200M+ updated products on a daily basis, providing users with powerful tools like supplier search, wholesale scanning, competitor analysis, and automated profit calculations. The platform helps Amazon sellers maximize profits and save valuable time by automating the tedious process of product sourcing and analysis. Working on such data-intensive applications has deepened my understanding of how modern web technologies can solve real-world business challenges and create meaningful impact for users. If you want to find out more about us, visit our website or contact me directly throught <Link href="https://www.linkedin.com/in/dominik-huber-7a4394227/" className="font-medium underline underline-offset-2 hover:text-accent-500">LinkedIn</Link>.
          </p>
