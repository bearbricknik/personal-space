...
const AboutMe = () => {
  return (
    <>
      ...
      <p>Ich bin ein wenig Besessen von guten Designs. Da ich in meiner Firma derjenige bin, der das Aussehen einer Webseite oder App programmiert, lege ich besonderen Wert auf gutes Design (Ich hoffe man sieht das auch).</p>
      <p>Vielleicht hast du dich bis hier hin gefragt, warum ich zwei Roadtrip Ziele in Italien ausgewählt habe? Nun, ich bin ein sehr großer Pizza Liebhaber. P.S: Ich würde trotzdem mit dir meine Pizza teilen (<PlusPunkt brackets={false} />).</p>
